        ...
        $(document).ready(function() {
            ...
            $('.tambah-jabatan-majelis').on('click', function() {
                ...
                Swal.fire({
                    ...
                    html: `
                        <form id="addJabatan MajelisForm">
                            <div class="form-group">
                                <label for="noJabatan">ID Jabatan Majelis</label>
                                <input type="text" id="noJabatan" class="form-control" placeholder="Masukkan Nomor Jabatan">
                            </div>
                            <div class="form-group mb-0">
                                <label for="namaJabatan">Nama Jabatan Majelis</label>
                                <input type="text" id="namaJabatan" class="form-control" placeholder="Masukkan Nama Jabatan Majelis">
                            </div>
                        </form>
                    `,
                    ...
                    preConfirm: () => {
                        ...
                        if (!noJabatan || !namaJabatan) {
                            Swal.showValidationMessage(
                                'ID Jabatan Majelis dan Nama Jabatan Majelis harus diisi!');
                            return false;
                        }
                    ...
                    if (result.isConfirmed) {
                        ...
                        // AJAX request untuk menambah Jabatan Majelis
                        $.ajax({
                            url: '/add-jabatan-majelis',
                            type: 'POST',
                            data: {
                                _token: '{{ csrf_token() }}',
                                noJabatan: noJabatan,
                            ...
                            error: function(xhr, status, error) {
                                alert.fire({
                                    icon: 'error',
                                    title: 'Terjadi keslahan saat menambahkan data Jabatan Majelis!'
                                });
                            }
                        });
                    }
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                alert.fire({
                                    icon: 'success',
                                    title: 'Data Jabatan Majelis berhasil diupdate!'
                                });
                            ...
                            error: function(xhr, status, error) {
                                alert.fire({
                                    icon: 'error',
                                    title: 'Data Jabatan Majelis gagal diupdate!'
                                });
                            }
                        });
                    }
