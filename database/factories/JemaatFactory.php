...
class JemaatFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'id_nikah' => Pernikahan::inRandomOrder()->first()->id_nikah,
            'id_sidi' => BaptisSidi::inRandomOrder()->first()->id_sidi,
            'id_ba' => BaptisAnak::inRandomOrder()->first()->id_ba,
            'id_bd' => BaptisDewasa::inRandomOrder()->first()->id_bd,
